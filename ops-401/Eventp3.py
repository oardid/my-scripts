...
# Script Name:                  ops401-challenge28
# Author:                       Omar Ardid
# Date of latest revision:      06/05/2024
# Purpose:                      Adding FileHandler logs write to a local file and StreamHandler should output to the terminal
# Resources:                    https://realpython.com/python-logging/#using-handlers
...
file_handler = RotatingFileHandler('port_scanner.log', maxBytes=1e6, backupCount=3)
